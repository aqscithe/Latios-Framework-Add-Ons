...
namespace Latios.Anna.Electromagnetism.Systems
{
    ...
    /// 4. <see cref="ComputeReceiverForcesSystem"/> — sample grid for every
    ...
    ///
    /// Tier 2 will slot Phase C (permeability propagation) between Phase B
    /// and Phase D. Tier 3 will slot Phase E (Faraday induction) before D.
    /// </summary>
    [DisableAutoCreation]
